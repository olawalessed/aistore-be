...
INSERT INTO `__new_stores`("id", "name", "slug", "email", "plan", "country", "city", "address", "whatsapp", "phone", "email_verified", "email_verification_token", "email_verification_expires", "source_connected", "airtable_base_id", "airtable_product_table", "airtable_settings_table", "airtable_api_key", "airtable_api_key_iv", "sync_interval", "status", "last_sync_at", "created_at") SELECT "id", "name", "slug", "email", "plan", "country", "city", "address", "whatsapp", "phone", "email_verified", "email_verification_token", "email_verification_expires", "source_connected", "airtable_base_id", "airtable_product_table", "airtable_settings_table", "airtable_api_key", "airtable_api_key_iv", "sync_interval", "status", "last_sync_at", "created_at" FROM `stores`;--> statement-breakpoint
